...
export default function LoginForm({ onLogin, onSwitchToRegister }: LoginFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const role = email.includes("owner") ? "owner" : "user"
    onLogin(role)
    setIsLoading(false)
  }
  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      <CardHeader className="text-center">
        ...
        <CardDescription className="font-open-sans">Sign in to your ParknPal account</CardDescription>
      </CardHeader>
      <CardContent>
        ...
        <div className="mt-6 space-y-3">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-card px-2 text-muted-foreground font-open-sans">Or continue with</span>
            </div>
          </div>

          <Button variant="outline" className="w-full font-open-sans bg-transparent" type="button">
